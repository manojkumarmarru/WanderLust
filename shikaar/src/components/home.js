...
import Hotdeals1 from './Hotdeals';
//import StaticPackage from './static-packages'; /// tharun commented
                    ...
                    Not all those who wander are lost.</h2>
                            <div className="form-inline d-flex">
                                <input
                                    ...
                                    onKeyPress={(e)=>{this.getPackages(e)}}
                                    onChange={this.handleChange}
                                    id="continent"
                                />&nbsp;
                    <button className="btn btn-primary" value={"SearchButton"} onClick={this.getPackages}>Search</button>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-lg-8 mx-auto">
                                ...
                                <p className="about-paragraph text-center">When someone makes a travel plan, the first few things they want to sort out, are flights, accomodation and other amenities for a convienient holiday. To enjoy holidays, you want to have the basics taken care of, especially for family vacations and honeymoon trips. You want your accomodation, return flight bookings, meals of the days and other travelling formalities sorted beforehead. At Wandelust, we take care of all the requirements to ensure that you get to enjoy the best of your holiday, exploring and experiencing the destination.</p>
                            </div>
                        </div>
                    </div>
                </section>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50"><Link to="/home">manojkumarmarru@gmail.com</Link></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50">+91 9848022338</div>
                                    </div>
                                </div>
                            </div>
                        </div>
